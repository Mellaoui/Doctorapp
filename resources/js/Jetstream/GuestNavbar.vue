  ...
  <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
    <div class="relative flex items-center justify-between h-16">
      ...
      <div class="hidden sm:block sm:ml-6">
            ...
            <input type="search" class="bg-gray-600 shadow rounded border-0 p-3" placeholder="Search by name...">
        ...
        <div class="ml-3 relative">
          <div>
            <button class="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu" aria-haspopup="true">
              <a :href=" route('login') " class="bg-gray-800 text-white block px-3 py-2 rounded-md text-base font-medium">Login</a>
            </button>
          </div>
          <!--
          ...
          <div>
            <button class="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu" aria-haspopup="true">
              <a :href="route('register')" class="bg-gray-800 text-white block px-3 py-2 rounded-md text-base font-medium">Register</a>
            </button>
          </div>
          <!--
            Profile dropdown panel, show/hide based on dropdown state.
